...
export const appConfig: ApplicationConfig & { overrideStartLayoutId?: string } = {
  ...
  providers: [
    ...
    { provide: MODEL_BACKEND, useClass: VifuModelService }, // Uses Vifu SDK AI when hosted by Vifu
    // { provide: MODEL_BACKEND, useClass: LmStudioService }, // Uncomment to use LM Studio directly
